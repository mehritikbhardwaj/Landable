...
import com.landable.app.ui.home.dataModels.MonthsDataModel

class MonthsDropdownAdapter(
    var activity: Activity?, var list: ArrayList<MonthsDataModel>?,
   /* private var dropDownListClickListener: DropDownListClickListener*/
    ...
    override fun getItem(position: Int): MonthsDataModel {
    ...
    fun updateList(list1: ArrayList<MonthsDataModel>?) {
        list = list1
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun convertResultToString(resultValue: Any?): CharSequence {
                return (resultValue as MonthsDataModel).value
            }
