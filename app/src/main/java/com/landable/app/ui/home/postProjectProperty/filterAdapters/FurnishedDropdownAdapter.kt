...
class FurnishedDropdownAdapter(
    var activity: Activity?, var list: ArrayList<Arbitragemaster>,
    ...
    override fun getItem(position: Int): Arbitragemaster {
    ...
    fun updateList(list1: ArrayList<Arbitragemaster>) {
        list = list1
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun convertResultToString(resultValue: Any?): CharSequence {
                return (resultValue as Arbitragemaster).codevalue
            }
