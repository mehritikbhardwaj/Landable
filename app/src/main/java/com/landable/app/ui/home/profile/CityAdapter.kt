...
class CityAdapter (var activity: Activity?, var list: ArrayList<Citymaster>?): BaseAdapter(),
    Filterable {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        textView.text = getItem(position).city

        return view
    }

    fun updateList(list1: ArrayList<Citymaster>?) {
        list = list1
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun convertResultToString(resultValue: Any?): CharSequence {
                return (resultValue as Citymaster).city
            }
