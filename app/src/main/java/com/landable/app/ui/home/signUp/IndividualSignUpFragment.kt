...
import com.landable.app.databinding.FragmentIndiviualSignUpBinding
...
class IndividualSignUpFragment : Fragment(), IListener {
    ...
    override fun onCreateView(
        ...
        binding.checkboxSubscribe.setOnCheckedChangeListener { _, b ->
            if (viewModel != null) {
                ...
                else viewModel!!.isAcceptedSubscription = "No"
            }
        }
        binding.checkboxTMC.setOnCheckedChangeListener { _, b ->
            if (viewModel != null) {
                ...
                else viewModel!!.isAcceptedTermAndCondition = "No"
            }
        }
                        ...
                        if (it == LandableConstants.noInternetErrorMessage) {
                            ...
                            try {
                                ...
                                if (status == "This mobile number is already registered on landable, try to login or reset password.") {
                                    ...
                                    Toast.makeText(requireContext(),otp.toString(), Toast.LENGTH_LONG).show()
                                ...
                                CustomAlertDialog(requireContext(), "Alert", e.message!!).show()
                            }
